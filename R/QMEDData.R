...
#'
#' A data.frame of catchment & data descriptors relating to the median annual maximum flow (QMED). NRFA Peak Flow Dataset - Version 12.1
#'
...
#'
#' @format A data frame with 894 rows and 26 variables
